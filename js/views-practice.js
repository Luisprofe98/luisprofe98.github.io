...
window.PracticeViews = (() => {
  ...
  function checkPrediction(id,reveal=false) {
    ...
    if(!reveal){Progress.touch();Progress.save();}
  }
  function debug(p) {
